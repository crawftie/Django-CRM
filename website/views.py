...
def list_users(request):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        return render(request, 'admin_templates/list_users.html', {'regular_users': regular_users, 'super_users': super_users})
    else:
        messages.success(
            request, "You have to be an Admin to view the Admin Portal")
        return redirect('home')
...
def add_specialism(request):
    ...
    if request.user.is_authenticated:
        ...
        messages.success(
            request, "You have to be logged in to make a new specialism")
        return redirect('home')
...
def add_doctor(request):
    ...
    if request.user.is_authenticated:
        ...
        messages.success(
            request, "You have to be logged in to add a new Doctor")
        return redirect('home')
...
def add_hospital(request):
    ...
    if request.user.is_authenticated:
        ...
        messages.success(
            request, "You have to be logged in to add a new Hospital")
        return redirect('home')
...
def add_user(request):
    ...
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        messages.success(
            request, "You have to be an admin in to add a New User from inside the Portal")
        return redirect('home')
...
def update_specialism(request, pk):
    if request.user.is_authenticated:
        ...
        form = AddSpecialismRecordForm(
            request.POST or None, instance=current_specialism_record)
        if form.is_valid():
            form.save()
...
def update_user(request, pk):
    if request.user.is_authenticated and request.user.is_superuser:
        current_user_record = get_object_or_404(User, id=pk)
        form = UpdateUserForm(request.POST or None,
                              instance=current_user_record)
        ...
        if request.method == 'POST':
            ...
            is_superuser = current_user_record.is_superuser
            form = UpdateUserForm(instance=current_user_record, initial={
...
def update_user_password(request, pk):
    if request.user.is_authenticated:
        ...
        form = UpdateUserPasswordForm(
            request.POST or None, instance=current_user_record)
        if form.is_valid():
            form.save()
...
def admin_update_user_password(request, pk):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        messages.success(
            request, "You have to be a superuser to update a user's password")
        return redirect('home')
...
def delete_specialism(request, pk):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        messages.success(
            request, "You have to be logged in to delete a Specialism Record")
        return redirect('list_specialisms')
...
def delete_hospital(request, pk):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        messages.success(
            request, "You have to be an admin in to delete a Hospital Record")
        return redirect('list_hospitals')
...
def delete_doctor(request, pk):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        messages.success(
            request, "You have to be logged in to delete a Doctor Record")
        return redirect('list_doctors')
...
def delete_user(request, pk):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        messages.success(
            request, "You have to be an Admin to delete a User Record")
        return redirect('home')
